...
ln\Bigl(\frac{n}{\sqrt{2\pi}\sigma}\Bigr)+\sum_{i=1}^{n}ln\Bigl( exp(-\frac{1}{2}\frac{(y_i-X\beta_i)^2}{\sigma^2})\Bigr)=
\end{equation*}

\begin{equation}
=ln\Bigl(\frac{n}{\sqrt{2\pi}\sigma}\Bigr)+\sum_{i=1}^{n}\Bigl( -\frac{1}{2}\frac{(y_i-X\beta_i)^2}{\sigma^2}\Bigr)
\end{equation}

\begin{equation*}
ln(p(\beta)) = ln\Bigl( \prod_{k=1}^{p}\frac{1}{\sqrt{2\pi}\sigma_{\beta}} exp(-\frac{1}{2}\frac{\beta_k^2}{\sigma^2_{\beta}})\Bigr)=
ln\Bigl(\frac{p}{\sqrt{2\pi}\sigma_{\beta}}\Bigr)+\sum_{k=1}^{p}ln\Bigl( exp(-\frac{1}{2}\frac{\beta_k^2}{\sigma^2_{\beta}})\Bigr)=
\end{equation*}

\begin{equation}
=ln\Bigl(\frac{p}{\sqrt{2\pi}\sigma_{\beta}}\Bigr)+\sum_{k=1}^{p}\Bigl( -\frac{1}{2}\frac{\beta_k^2}{\sigma^2_{\beta}}\Bigr)
\end{equation}
...
ln\Bigl(\frac{p}{2b}\Bigr)+\sum_{k=1}^{p}ln\Bigl(exp(-\frac{|\beta_k|}{b})\Bigr)=
\end{equation*}

\begin{equation}
=ln\Bigl(\frac{p}{2b}\Bigr)+\sum_{k=1}^{p}\Bigl(-\frac{|\beta_k|}{b}\Bigr)
\end{equation}
